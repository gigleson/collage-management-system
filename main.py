...
def login():
    ...
    db = mysql.connector.connect(host="localhost", user="phpmyadmin", password="kaushal", database="nsec_db")
    mycursor = db.cursor()
...
#heading label
nsec=Label(header, text="WELCOME TO OUR PAGE",font=("Helvetica",30,"bold"), bg = "brown",fg="#eae2b7")
nsec.place(x=500, y=20, width=600)
